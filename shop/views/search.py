...
def search(request):
    if request.method == "POST":
        ...
        return render(request, 'search.html', {'searched_product_from_input':searched_product_from_input,'all_products':products,'searched_products':searched_products,'categories':categories})